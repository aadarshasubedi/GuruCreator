...
void	lua_pushobject( lua_State* state, std::shared_ptr<GameObject> obj )
{
	if( !obj ) { return; }
...
std::shared_ptr<GameObject> lua_toobject( lua_State* state, int arg )
{
...
{
	std::shared_ptr<GameObject> obj = lua_toobject(L,1);
