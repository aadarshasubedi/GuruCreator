...
public:
	...
	//This function is the render function to complement GPicker and selecting objects.
	virtual void renderSelectionMode() = 0;
	virtual void pickRenderableScene(const int& x, const int& y) = 0;
	GPicker* mPicker;
